...
% ability modifiers
\newcommand{\STRmod}{\floor{(\STR - 10)/2}}
\newcommand{\DEXmod}{\floor{(\DEX - 10)/2}}
\newcommand{\CONmod}{\floor{(\CON - 10)/2}}
\newcommand{\INTmod}{\floor{(\INT - 10)/2}}
\newcommand{\WISmod}{\floor{(\WIS - 10)/2}}
\newcommand{\CHAmod}{\floor{(\CHA - 10)/2}}

% proficiency bonus
% {2 + (Total Level-1)/4}Rounded Down
\newcommand{\ProficiencyBonus}{\floor{2 + ((\Level - 1) / 4)}}
...
}
{
  ...
  \FPeval{\SpellAttackBonus}{trunc(\ProficiencyBonus + \SpellMod +\SpellModBonus:0)}
}
