...
%hit points
\FPeval{\BaseHP}{6+4+4+4+4+4} %add rolls at each level

%hit dice
\newcommand{\HitDice}{d6}

%actions
\newcommand{\HalfWizardLevel}{\floor{\Level/2}}
\newcommand{\Actions}{
  Extra Attack - You can attack twice whenever you take the attack action on
  your turn. Moreover, you can cast a cantrip in place of one of those attacks.\\
  ...
  \textbf{Special Actions:\\} Arcane Recovery \textbullet\ 1/Long Rest \textbullet\ \HalfWizardLevel\ levels\\
...
%attacks
\newcommand{\Attacks}{
  \attack{Rapier +1}{5ft.}{}{\texttt{+}\FPeval{\RapierHit}{trunc(\ProficiencyBonus+\DEXmod+1:0)}\RapierHit}{1d8\texttt{+}\number\numexpr\DEXmod+1\relax}{piercing}{Finesse}\\
  \attack{Dagger}{5ft.}{20(60)}{\texttt{+}\FPeval{\DaggerHit}{trunc(\ProficiencyBonus+\DEXmod:0)}\DaggerHit}{1d4\texttt{+}\DEXmod}{piercing}{Fin, Lgt, Throw}\\
  \attack{Whip}{10ft.}{}{\texttt{+}\DEXmod}{1d4\texttt{+}\DEXmod}{slashing}{Finesse, Reach}\\
  \\
  \attack{Booming Blade}{}{5ft.}{}{atk\texttt{+}1d8}{thunder}{V,M \texttt{+}2d8 on move}\\
  \attack{Fire Bolt}{}{120ft.}{\texttt{+}\FPeval{\FireBoltHit}{trunc(\ProficiencyBonus+\INTmod+\SpellModBonus:0)}\FireBoltHit}{2d10}{fire}{V,S}\\
  \attack{Shocking Grasp}{}{Touch}{\texttt{+}\FPeval{\ShockingGraspHit}{trunc(\ProficiencyBonus+\INTmod+\SpellModBonus:0)}\ShockingGraspHit}{2d8}{lightning}{V,S}
}
...
\newcommand{\Equipment}{
  ...
  \dnditem{Rapier +1}{1}{2}{-}{\tiny{martial, finesse}}\\
  ...
  \dnditem{Driftglobe}{1}{1}{500}{Item Card}\\
  \dnditem{Blue Star Sapphire}{1}{-}{1000}{piece of Azuredge battleaxe}\\
  \dnditem{Sarifal Challenge Coin}{1}{-}{-}{grants entry to Sarifal}\\
  \dnditem{Spell Scrolls}{2}{-}{-}{\tiny{Bestow Curse (3rd), Knock (2nd)}}\\
  ...
  \dnditem{Hat of Wizardy}{1}{-}{400}{\tiny{focus, cast any cantrip, DC10 Arcana}}\\
}
...
\newcommand{\Features}{
  ...
  \textbf{Copying Spells:} 2 hours and 50gp per spell level. 1 hour and 10gp to copy your own spells.\\

  \textbf{Cantrip Formulas:} Replace one wizard cantrip with another after a long rest.\\
  ...
  \end{itemize}
  \textbf{Whip Proficiency:}\\
  \vspace{-2em}
  \begin{itemize}
    \setlength\itemsep{-0.5em}
    \item proficiency: 150 - 200 hours
    \item mastery: 300 hours
  \end{itemize}
}

%whip time
\newcommand{\WhipHours}{22}
