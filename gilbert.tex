...
\newcommand{\Actions}{
  ...
  see within 30 ft. The target must succeed on a \textbf{STR save} or be moved 5
  ...
  \textbf{Prepared Spells:\\}
  \textbf{Cantrips:} Acid Splash, Light, Mage Hand, Ray of Frost\\
  \textbf{1st Level:} Burning Hands, Comprehend Languages, Detect Magic, Mage Armor, Magic Missile\\
}
