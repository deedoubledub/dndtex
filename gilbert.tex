...
%hit points
\FPeval{\BaseHP}{6+4+4} %add rolls at each level
...
\newcommand{\Attacks}{
  ...
  \attack{Fire Bolt}{}{120ft.}{\texttt{+}\FPeval{\FireBoltHit}{trunc(\ProficiencyBonus+\INTmod:0)}\FireBoltHit}{1d10}{fire}{V,S}
  %\attack{Ray of Frost}{}{60}{\texttt{+}\FPeval{\RayFrostHit}{trunc(\ProficiencyBonus+\INTmod:0)}\RayFrostHit}{1d8}{cold}{V,S}
  %\attack{Shocking Grasp}{}{Touch}{\texttt{+}\FPeval{\ShockingGraspHit}{trunc(\ProficiencyBonus+\INTmod:0)}\ShockingGraspHit}{1d8}{lightning}{V,S}
}
...
\newcommand{\Equipment}{
  ...
  \dnditem{Dagger}{2}{2}{4}{\tiny{simple, finesse, light, thrown, range (20/60)}}\\
  ...
  \dnditem{Parchment}{310}{-}{31}{\tiny{communication, social, utility, consumable}}\\
  ...
  \dnditem{Scroll of Catapult}{1}{-}{-}{1st Level Transmutation}\\
